...
namespace LibGit2Sharp
{
    ...
    public class BranchTrackingDetails
    {
        ...
        private readonly LibGit2Sharp.Core.Compat.Lazy<LibGit2Sharp.Core.Compat.Tuple<int?, int?>> aheadBehind;
        private readonly LibGit2Sharp.Core.Compat.Lazy<Commit> commonAncestor;
        ...
        internal BranchTrackingDetails(Repository repo, Branch branch)
        {
            ...
            aheadBehind = new LibGit2Sharp.Core.Compat.Lazy<LibGit2Sharp.Core.Compat.Tuple<int?, int?>>(ResolveAheadBehind);
            commonAncestor = new LibGit2Sharp.Core.Compat.Lazy<Commit>(ResolveCommonAncestor);
        }
        ...
        private LibGit2Sharp.Core.Compat.Tuple<int?, int?> ResolveAheadBehind()
        {
            return branch.IsTracking
                       ? Proxy.git_graph_ahead_behind(repo.Handle, branch.TrackedBranch.Tip, branch.Tip)
                       : new LibGit2Sharp.Core.Compat.Tuple<int?, int?>(null, null);
        }
