...
namespace LibGit2Sharp
{
    ...
    public sealed class Repository : IRepository
    {
		...
		private readonly LibGit2Sharp.Core.Compat.Lazy<Configuration> config;
        private readonly RepositorySafeHandle handle;
        private readonly Index index;
        private readonly ReferenceCollection refs;
        private readonly TagCollection tags;
        private readonly StashCollection stashes;
		private readonly LibGit2Sharp.Core.Compat.Lazy<RepositoryInformation> info;
        private readonly Diff diff;
        private readonly NoteCollection notes;
		private readonly LibGit2Sharp.Core.Compat.Lazy<ObjectDatabase> odb;
		private readonly LibGit2Sharp.Core.Compat.Lazy<Network> network;
		...
		private static readonly LibGit2Sharp.Core.Compat.Lazy<string> versionRetriever = new LibGit2Sharp.Core.Compat.Lazy<string>(RetrieveVersion);
		private readonly LibGit2Sharp.Core.Compat.Lazy<PathCase> pathCase;
        ...
        public Repository(string path, RepositoryOptions options = null)
        {
            ...
            try
            {
                ...
                info = new LibGit2Sharp.Core.Compat.Lazy<RepositoryInformation>(() => new RepositoryInformation(this, isBare));
                config =
                    new LibGit2Sharp.Core.Compat.Lazy<Configuration>(
                        () =>
                ...
                odb = new LibGit2Sharp.Core.Compat.Lazy<ObjectDatabase>(() => new ObjectDatabase(this));
                diff = new Diff(this);
                notes = new NoteCollection(this);
                ignore = new Ignore(this);
                network = new LibGit2Sharp.Core.Compat.Lazy<Network>(() => new Network(this));
                pathCase = new LibGit2Sharp.Core.Compat.Lazy<PathCase>(() => new PathCase(this));
		...
		public static string CloneNoCheckCer(string sourceUrl, string workdirPath,
		                           bool bare = false,
		                           bool checkout = true,
		                           TransferProgressHandler onTransferProgress = null,
		                           CheckoutProgressHandler onCheckoutProgress = null,
