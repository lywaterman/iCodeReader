...
namespace LibGit2Sharp
{
    ...
    {
		private LibGit2Sharp.Core.Compat.Lazy<GitObject> target;
            ...
            return new TreeEntryDefinition
                       {
                           ...
                           target = new LibGit2Sharp.Core.Compat.Lazy<GitObject>(() => treeEntry.Target)
                       };
        }
            ...
            return new TreeEntryDefinition
                       {
                           ...
                           TargetId = blob.Id,
                           target = new LibGit2Sharp.Core.Compat.Lazy<GitObject>(() => blob)
                       };
        }
            ...
            return new TreeEntryDefinition
                       {
                           ...
                           TargetId = objectId,
                           target = new LibGit2Sharp.Core.Compat.Lazy<GitObject>(() => { throw new InvalidOperationException("Shouldn't be necessary."); }),
                       };
        }
            ...
            return new TreeEntryDefinition
                       {
                           ...
                           TargetId = tree.Id,
                           target = new LibGit2Sharp.Core.Compat.Lazy<GitObject>(() => tree)
                       };
        }
