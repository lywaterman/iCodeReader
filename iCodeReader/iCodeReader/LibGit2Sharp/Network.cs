...
namespace LibGit2Sharp
{
    ...
    public class Network
    {
		...
		private readonly LibGit2Sharp.Core.Compat.Lazy<RemoteCollection> remotes;
        ...
        internal Network(Repository repository)
        {
            ...
            remotes = new LibGit2Sharp.Core.Compat.Lazy<RemoteCollection>(() => new RemoteCollection(repository));
        }
