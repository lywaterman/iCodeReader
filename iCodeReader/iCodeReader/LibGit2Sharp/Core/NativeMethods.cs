...
namespace LibGit2Sharp.Core
{
    internal static class NativeMethods
    {
		...
		[DllImport(libgit2)]
		internal static extern void git_remote_check_cert(
			RepositorySafeHandle repo,
			int check);
        ...
        internal static extern int git_diff_blobs(
            ...
            [MarshalAs(UnmanagedType.CustomMarshaler,  MarshalTypeRef = typeof(FilePathMarshaler))] FilePath old_as_path,
            GitObjectSafeHandle newBlob,
            [MarshalAs(UnmanagedType.CustomMarshaler,  MarshalTypeRef = typeof(FilePathMarshaler))] FilePath new_as_path,
            GitDiffOptions options,
        ...
        internal static extern int git_submodule_lookup(
            ...
            RepositorySafeHandle repo,
            [MarshalAs(UnmanagedType.CustomMarshaler,  MarshalTypeRef = typeof(FilePathMarshaler))] FilePath name);
