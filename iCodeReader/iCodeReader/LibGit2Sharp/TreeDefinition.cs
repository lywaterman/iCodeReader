...
namespace LibGit2Sharp
{
    ...
    public class TreeDefinition
    {
        ...
        public virtual TreeDefinition Remove(string treeEntryPath)
        {
            ...
            LibGit2Sharp.Core.Compat.Tuple<string, string> segments = ExtractPosixLeadingSegment(treeEntryPath);
        ...
        public virtual TreeDefinition Add(string targetTreeEntryPath, TreeEntryDefinition treeEntryDefinition)
        {
            ...
            LibGit2Sharp.Core.Compat.Tuple<string, string> segments = ExtractPosixLeadingSegment(targetTreeEntryPath);
        ...
        internal Tree Build(Repository repository)
        {
            ...
            {
                var builtTreeEntryDefinitions = new List<LibGit2Sharp.Core.Compat.Tuple<string, TreeEntryDefinition>>(entries.Count);
                ...
                foreach (KeyValuePair<string, TreeEntryDefinition> kvp in entries)
                {
                    ...
                    builtTreeEntryDefinitions.Add(new LibGit2Sharp.Core.Compat.Tuple<string, TreeEntryDefinition>(name, ted2));
		...
		private static LibGit2Sharp.Core.Compat.Tuple<string, string> ExtractPosixLeadingSegment(FilePath targetPath)
        {
            ...
            return new LibGit2Sharp.Core.Compat.Tuple<string, string>(segments[0], segments.Length == 2 ? segments[1] : null);
        }
