...
namespace LibGit2Sharp
{
    ...
    public class NoteCollection : IEnumerable<Note>
    {
		...
		private readonly LibGit2Sharp.Core.Compat.Lazy<string> defaultNamespace;
        ...
        {
            this.repo = repo;
            defaultNamespace = new LibGit2Sharp.Core.Compat.Lazy<string>(RetrieveDefaultNamespace);
        }
